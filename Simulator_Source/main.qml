...
Window {
    ...
    function saveData() {
        ...
        climated.setData(driverTemp.realValue,passengerTemp.realValue,fanLevel.value,driver_wind_mode.currentIndex,passenger_wind_mode.currentIndex,auto_mode.currentIndex,sync_mode.currentIndex)
    }

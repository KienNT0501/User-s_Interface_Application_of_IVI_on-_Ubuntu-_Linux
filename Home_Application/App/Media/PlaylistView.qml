    ...
    ListView{
        ...
        delegate: MouseArea {
            ...
            Image {
                ...
                height: 120
                source: "qrc:/App/ASM4/Image/playlist.png"
                opacity: 0.5
            }
            Text {
                text: nameSong
            ...
            onPressed: {
                playlistItem.source = "qrc:/App/ASM4/Image/hold.png"
            }
            onReleased: {
                playlistItem.source = "qrc:/App/ASM4/Image/playlist.png"
            }
        }
